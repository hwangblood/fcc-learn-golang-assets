...
func (apiCfg *apiConfig) handlerDeleteFeedFollow(
	...
	if paramErr != nil {
		responseWithError(w, 400, fmt.Sprintf("Couldn't parse feed follow id: %v", paramErr))
		return
	}
	...
	if deleteErr != nil {
		responseWithError(w, 400, fmt.Sprintf("Couldn't delete feed follow: %v", deleteErr))
		return
	}
